...
public class Dumps
{
        ...
        public static SortedDictionary<int, byte> Read_128k_v0D(int adr, int cntr){
        	...
        	if (crntModul != "Read_128000v0D") Load_Dump_v0D(Dumps.Read_128000v0D, "Read_128000v0D");
        ...
        public static SortedDictionary<int, byte[]> ReadBlocks_128000(SortedDictionary<int, byte[]> adrBt){
        	...
        	if (crntModul != "ReadBlocks_128000v14_25") Load_Dump_v0D(Dumps.ReadBlocks_128000v14_25, "ReadBlocks_128000v14_25");
		...
		public static SortedDictionary<int, byte[]> Read_by_Mask128000(SortedDictionary<int, byte[]> stdctnr){
        	...
        	if (crntModul != "Read_128000v14_25") Load_Dump_v0D(Dumps.Read_128000v14_25, "Read_128000v14_25");	
        ...
        public static void Write_RAM_128000(SortedDictionary<int, byte[]> adrBt){
        	...
        	if (crntModul != "Write_RAM_128000v14_25") Load_Dump_v0D(Dumps.Write_RAM_128000v14_25, "Write_RAM_128000v14_25");	
        ...
        public static void Copy_RAM_128000(int adrDst, int adrSrc, int cntr){
        	...
        	int cntrCopy  = cntr;
        					if ( dstAdrCopy < 0x0000 | (dstAdrCopy + cntrCopy) > 0x03FF){
		        					...
		        					return;}
        	if (crntModul != "Copy_RAM_128000v14_25") Load_Dump_v0D(Dumps.Copy_RAM_128000v14_25, "Copy_RAM_128000v14_25");
        ...
        public static void WriteByte_EEPROM_128000(SortedDictionary<int, byte[]> adrBt){
        	...
        	if (crntModul != "WriteByte_EEPROM_128000v14_25") Load_Dump_v0D(Dumps.WriteByte_EEPROM_128000v14_25, "WriteByte_EEPROM_128000v14_25");
        ...
        public static void WriteWord_EEPROM_128000(SortedDictionary<int, byte[]> adrBt){
        	...
        	if (crntModul != "WriteWord_EEPROM_128000v14_25") Load_Dump_v0D(Dumps.WriteWord_EEPROM_128000v14_25, "WriteWord_EEPROM_128000v14_25");
        ...
        public static void WriteBlock_EEPROM_128000(SortedDictionary<int, byte[]> adrBt){
			...
			if (crntModul != "WriteBlock_EEPROM_128000v1425") Load_Dump_v0D(Dumps.WriteBlock_EEPROM_128000v1425, "WriteBlock_EEPROM_128000v1425");
        ...
        public static void WriteBlocks_EEPROM_128000(SortedDictionary<int, byte[]> adrBt){
			...
			if (crntModul != "WriteBlocks_EEPROM_128000v14_25") Load_Dump_v0D(Dumps.WriteBlocks_EEPROM_128000v14_25, "WriteBlocks_EEPROM_128000v14_25");
        ...
        public static void WriteBytes_OPTION_128000(SortedDictionary<int, byte> adrBt){
			...
			if (crntModul != "WriteBytes_OPTION_128000v1425") Load_Dump_v0D(Dumps.WriteBytes_OPTION_128000v1425, "WriteBytes_OPTION_128000v1425");
        ...
        public static void WriteByte_FLASH_128000(SortedDictionary<int, byte[]> adrBt){
			...
			if (crntModul != "WriteByte_FLASH_128000v14_25") Load_Dump_v0D(Dumps.WriteByte_FLASH_128000v14_25, "WriteByte_FLASH_128000v14_25");
        ...
        public static void WriteWord_FLASH_128000(SortedDictionary<int, byte[]> adrBt){
			...
			if (crntModul != "WriteWord_FLASH_128000v14_25") Load_Dump_v0D(Dumps.WriteWord_FLASH_128000v14_25, "WriteWord_FLASH_128000v14_25");
        ...
        public static void WriteBlocks_FLASH_128k_v0D(SortedDictionary<int, byte[]> adrBt){
			...
			if (crntModul != "WriteBlocks_FLASH_128000v0D") Load_Dump_v0D(Dumps.WriteBlocks_FLASH_128000v0D, "WriteBlocks_FLASH_128000v0D");
	...
	public static void read_Key_Close(){
	    ...
	    public static void Dump_To_Console(SortedDictionary<long, byte> rxAB, int alg){
	    	SortedDictionary<long, byte> AddressByte = new SortedDictionary<long, byte>(rxAB);
	    	if(err_Msg == " OK"){	//Console.Write(" " + err_Msg);
	    		long i = 0; long predAdr = 0;
	    		foreach( KeyValuePair<long, byte> kvp in AddressByte){
	    			if (i == 0) {	Console.Write(" ${0:X8} ", kvp.Key);
	    							predAdr = kvp.Key;}
	    			else { 
	    				if( (kvp.Key % alg) == 0 | (kvp.Key - predAdr) > 1) Console.Write("\n ${0:X8} ", kvp.Key); 
	    			}
	    ...
	    public static string Dumps_To_Console(SortedDictionary<long, byte[]> rxAB, int alg){
	    	SortedDictionary<long, byte[]> AddressByte = new SortedDictionary<long, byte[]>(rxAB);
	    	string strng = "";
	    	if(err_Msg == " OK"){	//Console.Write(" " + err_Msg);
	    		long ji = 0;
	    		foreach( KeyValuePair<long, byte[]> kvp in AddressByte){
	    			//int adr = kvp.Key;
	    			long j = 0;
	    			for(long i = 0; i < kvp.Value.Length ;){
	    				if(ji == 0) {
	    					Console.Write(" ${0:X8} ", kvp.Key);
...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
0x00, 0x00, 0x80, 0xCC, 0x86, 0x4F, 0x88, 0x28, 0xA6, 0x5F, 0x90, 0x5F, 0x94, 0xFF, 0x03, 0xAE, 
0xEF, 0x02 };
